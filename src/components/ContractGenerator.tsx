    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-300 shadow-xl p-6 md:p-10 text-slate-900 text-sm leading-relaxed" id="printable-contract">
        ...
        <div className="space-y-4 text-xs leading-relaxed">
          ...
          <div>
            <h3 className="font-bold uppercase text-center">5. ГАРАНТИЙНЫЕ ОБЯЗАТЕЛЬСТВА</h3>
            <p className="mt-1">5.1 Исполнитель гарантирует Заказчику качество выполняемых Работ.</p>
            <p>5.2 Гарантия на кондиционер предоставляется в соответствии с гарантией завода-изготовителя.</p>
            <p>5.3 Гарантия на выполняемые Работы Исполнителя составляет 12 (двенадцать) месяцев.</p>
            <p>5.4 Исполнитель не несет гарантийных обязательств за дефекты и не исправности, возникшие в следствие:</p>
            ...
            <p>5.5 Необходимым условием гарантийных обязательств является техническое обслуживание Оборудования персоналом Исполнителя. Само техническое обслуживание Оборудования к гарантийным обязательствам не относится и выполняется за дополнительную плату.</p>
          </div>
